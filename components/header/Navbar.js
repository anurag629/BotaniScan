    ...
    <div>
      ...
      >
        <div className="h-full px-3 pb-4 overflow-y-auto bg-black dark:bg-black">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Expert Chat Bot</span>
            ...
            <li>
              ...
              >
                <svg
                  ...
                  viewBox="0 0 18 18"
                >
                  <path d="M9 0a9 9 0 1 0 0 18A9 9 0 0 0 9 0Zm0 16.2A7.2 7.2 0 1 1 9 1.8a7.2 7.2 0 0 1 0 14.4Z" />
                  <path d="M9 4.5a1.8 1.8 0 0 0-1.8 1.8v3.6a1.8 1.8 0 0 0 3.6 0V6.3A1.8 1.8 0 0 0 9 4.5Z" />
                  <path d="M9 12.6a1.8 1.8 0 0 0-1.8 1.8v.9a.9.9 0 0 0 1.8 0v-.9A1.8 1.8 0 0 0 9 12.6Z" />
                </svg>
                <span className="flex-1 ml-3 whitespace-nowrap">Supported Plants</span>
          ...
          {/* Add the line break and add the contact us section */}
